@echo off
@REM LSET [#]target$ = expr : pack expr into the FIELD window for target$
@REM (left-justify, space-pad/truncate to the field WIDTH).  If target$ is
...
@REM field hit: build WIDTH bytes, left-justified
