@echo off
@REM AND: bitwise AND on 16-bit integers (GW-BASIC convention).
@REM Booleans use -1 (all bits) for true, 0 for false — bitwise AND on those
@REM gives the expected logical result.
